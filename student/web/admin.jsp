		...
		<nav>
			<div class="userinfo">
				<ul>
                    ...
                    <li><a href="EditServlet"><img src="icons/edit.gif" width="40" style="vertical-align: middle;"/></a></li>
				...
				<ul id="accordion" class="accordion">
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a onclick="fail_rate()">查询课程及格率</a></li>
							<li><a onclick="show_course_ranking()">查询课程排名</a></li>
						</ul>
					</li>
					<li>
